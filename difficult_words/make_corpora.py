...
make_corpora_file('old_text/magnetic_resonance_imaging', 'corpora', 'magnetic_resonance_imaging')
make_corpora_file('old_text/molecular_sequence_data', 'corpora', 'molecular_sequence_data')