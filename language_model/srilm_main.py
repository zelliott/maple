...
# 	"""
# 	Main function used to create and then subsequently test the language model.
# 	args:
# 		train_file_dir - A string containing the name of the directory 
# 		containing your train files.

# 	"""
# 	file_utils.convert_dir_to_file(train_file_dir, temp_train_file)
# 	build_model.make_model(temp_train_file)
